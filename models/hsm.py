...
class HSMNet(nn.Module):
    def __init__(self, maxdisp,clean,level=1):
        ...
        #stacked hourglass
        self.stacked_hourglass5=hourglass(16)
        self.stacked_hourglass4=hourglass(16)
        self.stacked_hourglass3=hourglass(16)
    ...
    def forward(self, left, right):
        ...
        feat5,pre5,post5=self.stacked_hourglass5(feat5,None,None)
        feat4,pre4,post4=self.stacked_hourglass4(feat4,None,None)
        feat3,pre3,post3=self.stacked_hourglass3(feat3,None,None)
